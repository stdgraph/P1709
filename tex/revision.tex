...
\begin{itemize}
\item Add default implementation for \tcode{target_id(g,uv)} when the graph matches the pattern \tcode{forward_range<forward_range<integral>>} 
      or \tcode{forward_range<forward_range<tuple<integral,...>>>}.
\end{itemize}
