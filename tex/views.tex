...
The \tcode{basic_sourced_edges_dfs(g,seed,evf)} basic view is required when using a \tcode{evf(eid)} function for edges. 
A \tcode{basic_edges_dfs} view with an \tcode{evf} is not available because \tcode{evf(eid)} requires that the \tcode{source_id} is available.
...
The \tcode{basic_sourced_edges_bfs(g,seed,evf)} basic view is required when using a \tcode{evf(eid)} function for edges. 
A \tcode{basic_edges_bfs} view with an \tcode{evf} is not available because \tcode{evf(eid)} requires that the \tcode{source_id} is available.
...
The \tcode{basic_sourced_edges_topological_sort(g,seed,evf)} basic view is required when using a \tcode{evf(eid)} function for edges. 
A \tcode{basic_edges_topological_sort} view with an \tcode{evf} is not available because \tcode{evf(eid)} requires that the \tcode{source_id} is available.
