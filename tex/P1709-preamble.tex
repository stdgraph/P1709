...
\newcommand{\scott}[1]{\xcomment{Scott}{#1}}
...
\fancyhead[L]{\copyright\,\textsc{ISO/IEC}}
\fancyhead[R]{\textbf{\docno}}
\fancyfoot{} % clear all footer fields
\fancyfoot[R]{\thepage}
\fancyfoot[L]{\S\thesubsection}
...
\newcommand{\stdgraph}{\textbf{graph-v2}\xspace}  % Can't call it \graphv2...can't use digits
