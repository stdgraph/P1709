...
%
We can express the graphs in those examples as
\[
\begin{array}{rcl}
G & = & \{ V, E \} \\[\smallskipamount]
V & = & \{ \mathrm{SEA}, \mathrm{MSP}, \mathrm{SLC}, \mathrm{DTW}, \mathrm{ATL}, \mathrm{BOS} \} \\[\smallskipamount]
E & = & \{ 
\{ \mathrm{MSP}, \mathrm{DTW} \}, 
\{ \mathrm{SLC}, \mathrm{SEA} \}, \\
&&\:\: 
\{ \mathrm{MSP}, \mathrm{SLC} \}, 
\{ \mathrm{BOS}, \mathrm{SLC} \}, \\
&&\:\: 
\{ \mathrm{SEA}, \mathrm{BOS} \}, 
\{ \mathrm{BOS}, \mathrm{ATL} \}, \\
&&\:\: 
\{ \mathrm{SEA}, \mathrm{MSP} \}, 
\{ \mathrm{BOS}, \mathrm{DTW} \} \}
\end{array}
\qquad
\begin{array}{rcl}
  G & = & \{ V, E \} \\[\smallskipamount]
