...
\begin{table}[h!]
  ...
  {\begin{tabular}{l l l p{7cm}}
     ...
     \tcode{VVP}        &                                   & \tcode{vvp}          & Vertex Value Projection function: vvp(x) $\rightarrow$ vertex value. Defaults to \tcode{identity<X>}.                                                                                            \\
     \hdashline
     ...
     \tcode{EVP}        &                                   & \tcode{evp}          & Edge Value Projection function: evp(y) $\rightarrow$ edge value. Defaults to \tcode{identity<Y>}.                                                                                                \\
     \hdashline
