...
\begin{table}[h!]
  ...
  {\begin{tabular}{l l l p{7cm}}
     ...
     \tcode{V}          & \tcode{vertex_t<G>}               &                      & Vertex descriptor                                                                                                                                                                                \\
                        & \tcode{vertex_t<G>}              & \tcode{u,v}          & Vertex descriptor. \tcode{u} is the source (or only) vertex. \tcode{v} is the target vertex.                                                                                                \\
     ...
     \tcode{E}          & \tcode{edge_t<G>}                 &                      & Edge descriptor                                                                                                                                                                                  \\
                        & \tcode{edge_t<G>}                 & \tcode{uv,vw}        & Edge descriptor. \tcode{uv} is an edge from vertices \tcode{u} to \tcode{v}. \tcode{vw} is an edge from vertices \tcode{v} to \tcode{w}.                                                       \\
