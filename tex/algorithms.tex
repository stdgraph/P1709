...
{\small
      \lstinputlisting[firstline=252,lastline=357]{src/alg_synopsis.hpp}
}
...
{\small
     \lstinputlisting[firstline=34,lastline=42]{src/connected_components.hpp}
}
\begin{itemdescr}
      \pnum\preconditions
      \begin{itemize}
...
{\small
     \lstinputlisting[firstline=47,lastline=51]{src/connected_components.hpp}
}
\begin{itemdescr}
      \pnum\preconditions
      \begin{itemize}
...
{\small
      \lstinputlisting[firstline=361,lastline=364]{src/alg_synopsis.hpp}
}
\begin{itemdescr}
      \pnum\preconditions
      \begin{itemize}
