...
{\small
\lstinputlisting[firstline=366,lastline=372]{src/alg_synopsis.hpp}
}
\begin{itemdescr}
\pnum\preconditions
\begin{itemize}
...
{\small
\lstinputlisting[firstline=376,lastline=385]{src/alg_synopsis.hpp}
}
...
{\small
\lstinputlisting[firstline=390,lastline=406]{src/alg_synopsis.hpp}
}
\begin{itemdescr}
\pnum\preconditions
\begin{itemize}
