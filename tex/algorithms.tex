...
\phil{Consider showing table with different algorithm classifications (sections) and individual algorithm signatures. Tier 1 doesn't have
much relevance in this context anymore.}
