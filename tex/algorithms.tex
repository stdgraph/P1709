...
to specify \tcode{Compare} and \tcode{Combine} functions (e.g. less and add). They are further split into 
overloads where one takes a \tcode{predecessors} argument and the other doesn't. Concepts and types from 
