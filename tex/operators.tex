...
{\small
      \lstinputlisting[firstline=2,lastline=4]{src/operators/sort.hpp}
}
\begin{itemdescr}
    \pnum\preconditions
    \begin{itemize}
...
{\small
      \lstinputlisting[firstline=6,lastline=8]{src/operators/sort.hpp}
}
\begin{itemdescr}
    \pnum\preconditions
    \begin{itemize}
...
{\small
      \lstinputlisting[firstline=10,lastline=11]{src/operators/sort.hpp}
}
\begin{itemdescr}
    \pnum\preconditions
    \begin{itemize}
...
{\small
      \lstinputlisting[firstline=13,lastline=16]{src/operators/sort.hpp}
}
\begin{itemdescr}
    \pnum\preconditions
    \begin{itemize}
