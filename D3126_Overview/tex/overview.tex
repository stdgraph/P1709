...
ad-hoc standardization effort to develop a set of kernel operations for supporting classical
graph algorithms.  As such, the GraphBLAS is not a a graph library per se, but is intended to be
