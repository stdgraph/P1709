...
Parallel versions of the algorithms are not included for several reasons. The \tcode{std::execution} proposal in P2300 \cite{REF_P2300} is expected to introduce new 
