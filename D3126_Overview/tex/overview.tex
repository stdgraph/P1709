...
The library targets C++23 as its baseline. \tcode{std::expected} from C++23 are used by the topological sort safe 
view factories (\tcode{vertices_topological_sort_safe} and \tcode{edges_topological_sort_safe}). 
