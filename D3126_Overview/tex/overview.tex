...
We are unable to support freestanding implementations in this proposal because many of the
algorithms and views require a \tcode{stack} or \tcode{queue}, which are not available in a freestanding environment. 
