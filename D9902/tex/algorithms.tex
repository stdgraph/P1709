...
{\small
     \lstinputlisting[firstline=4,lastline=6]{src/connected_components.hpp}
}
...
{\small
     \lstinputlisting[firstline=11,lastline=18]{src/connected_components.hpp}
}
...
{\small
     \lstinputlisting[firstline=23,lastline=28]{src/connected_components.hpp}
}
...
{\small
      \lstinputlisting[firstline=33, lastline=40]{src/connected_components.hpp}
}
\phil{Return number of components \tcode{C}? If \tcode{C==num_vertices(g)} then all components are of \tcode{size==1} (a.k.a. no components).}
...
{\small
      \lstinputlisting[firstline=45,lastline=51]{src/connected_components.hpp}
}
...
{\small
      \lstinputlisting{src/topological_sort_helpers.hpp}
}
...
{\small
      \lstinputlisting{src/topological_sort.hpp}
}
...
\chapter{Other Algorithms} \label{other_algo}
