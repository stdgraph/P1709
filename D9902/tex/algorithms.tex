...
{\small
     \lstinputlisting[firstline=11,lastline=18]{D9902/src/connected_components.hpp}
}
...
{\small
     \lstinputlisting[firstline=23,lastline=28]{D9902/src/connected_components.hpp}
}
...
{\small
      \lstinputlisting[firstline=33, lastline=40]{D9902/src/connected_components.hpp}
}
\phil{Return number of components \tcode{C}? If \tcode{C==num_vertices(g)} then all components are of \tcode{size==1} (a.k.a. no components).}
...
{\small
      \lstinputlisting[firstline=45,lastline=51]{D9902/src/connected_components.hpp}
}
