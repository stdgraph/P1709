...
\begin{itemize}
      ...
      \item Revise Dijkstra and Bellman-Ford algorithms to include a visitor parameter to 
            match boost::graph. Also removed extra overloads to keep the proposal small, 
