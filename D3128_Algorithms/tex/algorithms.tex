...
\phil{I added the multiple source versions because the cost skyrockets for Bellman-Ford if it needs to be run N times for N sources.}
...
\begin{itemdescr}
      ...
      \pnum\throws 
            \begin{itemize}
                  ...
                  \item \tcode{out_of_range} is thrown when the weight function returns a negative value.
            \end{itemize}
      \pnum\complexity
                        $\mathcal{O}((|E| + |V|)\log{|V|})$. 
