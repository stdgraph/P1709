...
\preconditions
            \begin{itemize}
                  ...
                  \item
                        \lstinline{distances[i] = breadth_first_search_infinite_distance()} for \lstinline{0 <= i < num_vertices(g)}.
                  \item
...
\begin{itemdescr}
      %\pnum\mandates
      \pnum\preconditions  The outgoing edges of a vertex are ordered by target\_id. \\
      %\pnum\effects
      %\pnum\result
