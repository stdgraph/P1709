...
{\small
      \lstinputlisting{D3128_Algorithms/src/bellman_ford_common.hpp}
      \lstinputlisting{D3128_Algorithms/src/bellman_ford_general.hpp}
}
...
\begin{itemdescr}
      ...
      \pnum\effects 
            \begin{itemize}
                  \item
                  \lstinline{label[uid]} is the label assignments of vertex id \lstinline{uid} discovered by label propagation.
            \end{itemize}
      %\pnum\result
      %\pnum\returns
      %\pnum\throws
      %\pnum\complexity
      \pnum\remarks
      The user is responsible for the initial vertex labels.
      %\pnum\errors
\end{itemdescr}
