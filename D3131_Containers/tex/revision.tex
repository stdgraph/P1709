...
\begin{itemize}
      ...
      \begin{itemize}
            \item Rename \tcode{descriptor} structs to \tcode{info} structs in preparation for new boost::graph-like descriptors.
            \item Remove \tcode{copyable_vertex} and \tcode{copyable_edge} from \tcode{compressed_graph} \tcode{requires} clause 
