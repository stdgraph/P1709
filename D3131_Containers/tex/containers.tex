...
For undirected graphs, edge pairs must be included for both directions, (uid,vid) and (vid,uid), when constructing the graph.
...
\phil{Use range-based descriptions. Concrete containers are also important, but stress that non-std containers can also be used.}
