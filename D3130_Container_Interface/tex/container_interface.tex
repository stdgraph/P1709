...
\hline
    ...
    \tcode{\textit{raw-vertex-id-type}} & \tcode{decltype(vertex_id(g,vertex_t<G>))} & exposition only \\
...
\hline
    ...
    \tcode{edges(g,u)} & \tcode{vertex_edge_range_t<G>} & constant & \tcode{u} if \tcode{forward_range<vertex_t<G>>}, n/a otherwise \\
...
\hline
    ...
    \tcode{find_vertex_edge(g,u,vid)} & \tcode{vertex_edge_t<G>} & linear & \tcode{find(edges(g,u),} \\
                                      &                          &        & \tcode{[](uv) \{ return target_id(g,uv)==vid; \})} \\
    ...
    \tcode{contains_edge(g,uid,vid)} & \tcode{bool} & constant & \tcode{uid < size(vertices(g))} \\
                                     ...
                                     &              & linear   & \tcode{find_vertex_edge(g,uid,vid)} \\
...
\hdashline
    ...
    \tcode{source(g,uv)} & \tcode{vertex_t<G>} & constant & \tcode{*(begin(vertices(g)) + source_id(g,uv))} \\
                         &                     &          & if \tcode{random_access_range<vertex_range_t<G>>} \\
                         &                     &          & \hspace{3mm}\tcode{\&\& integral<decltype(source_id(g,uv))>} \\
\hline
\end{tabular}}
...
\begin{itemize}
    ...
    \item \tcode{edge_info<integral,true,void,scalar>} with \tcode{source_id(e)}, \tcode{target_id(e)} and \tcode{edge_value(e)}.
\end{itemize}
