...
\hline
    ...
    \tcode{contains_edge(g,uid,vid)} & \tcode{bool} & constant & \tcode{uid < size(vertices(g))} \tcode{&& vid < size(vertices(g))} \\
    \                                &              &          & \hspace{5mm}if \tcode{is_adjacency_matrix_v<G>}.\\
    & & linear & \tcode{find_vertex_edge(g,uid)} \tcode{!= end(edges(g,uid))} otherwise. \\
\hdashline
