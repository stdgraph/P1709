...
The Graph Container Interface (GCI) defines the primitive concepts, traits, types and functions used to define and access an adjacency lists (aka graph)
...
\hline
    ...
    \tcode{find_vertex_edge(g,u,vid)} & \tcode{vertex_edge_t<G>} & linear & \tcode{find(edges(g,u),} \\
                                      &                          &        & \hspace{8mm}\tcode{[](uv) \{ return target_id(g,uv)==vid; \})} \\
