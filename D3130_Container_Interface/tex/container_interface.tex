...
\hline
    ...
    \tcode{edge_id_t<EL>} & \tcode{edge_descriptor<vertex_id_t<EL>,true,void,void>} & \\    
\hline
...
and \tcode{edge_id(e)} are always available.
...
\begin{table}[h!]
    ...
    \hline
        ...
        \tcode{edge_id(e)} & \tcode{edge_id_t<EL>} & constant & \tcode{edge_descriptor<vertex_id_t<EL>,true,void,void>\{source_id(e),target_id(e)\}} \\
...
Special patterns are recognized for edges based on the \tcode{tuple} and \tcode{edge_descriptor} types. When they are used the \tcode{source_id(e)}, 
...
The \tcode{edge_descriptor} patterns are
\begin{itemize}
    \item \tcode{edge_descriptor<integral,true,void,void>} with \tcode{source_id(e)} and \tcode{target_id(e)}.
    \item \tcode{edge_descriptor<integral,true,void,scaler>} with \tcode{source_id(e)}, \tcode{target_id(e)} and \tcode{edge_value(e)}.
\end{itemize}
