...
particularly useful because they abstract away the implementation details of the graph, allowing you to work with 
...
or vertices. For example, in a \tcode{vector} of \tcode{list} graph, the descriptor for a vertex is an index into the
