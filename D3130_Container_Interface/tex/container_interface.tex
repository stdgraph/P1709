...
Additionally, functions aren't distinguished by their return type, so there's little value in attempting to check it in this case.
...
The edge range concepts constrain out-edge and in-edge ranges.
{\small
...
high performance graphs where vertices are typically stored in a \tcode{vector}.
{\small
